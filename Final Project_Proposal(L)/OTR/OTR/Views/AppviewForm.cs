...
namespace OTR.Views
{
    public partial class AppviewForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
             ...
             MessageBox.Show("Book Id 1 Add to cart");
        ...
        private void tBSraech_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            MessageBox.Show("Book Id 4 Add to cart");
        }

        private void button2_Click_1(object sender, EventArgs e)
        {
            MessageBox.Show("Book Id 2 Add to cart");
        }

        private void button3_Click_1(object sender, EventArgs e)
        {
            MessageBox.Show("Book Id 3 Add to cart");
        }
    }
}
